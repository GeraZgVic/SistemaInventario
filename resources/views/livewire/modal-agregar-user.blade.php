        ...
        <div x-show="modalOpen" class="fixed top-0 left-0 z-[99] flex items-center justify-center w-screen h-screen"
            ...
            <div x-show="modalOpen" x-trap.inert.noscroll="modalOpen" x-transition:enter="ease-out duration-300"
                ...
                <div class="flex items-center justify-between pb-2">
                    <h3 class="text-lg font-semibold capitalize">Agregar Usuario</h3>
                ...
                <form 
                    ...
                    <div>
                        ...
                        <input wire:model='name' id="name" wire:dirty.class='border-green-500'
                    ...
                    <div>
                        ...
                        <input wire:model='email' id="email" wire:dirty.class='border-green-500'
                            class="w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm text-sm"
                    ...
                    <div>
                        ...
                        <input wire:model='password' id="password" wire:dirty.class='border-green-500'
                            class="w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm text-sm"
                    ...
                    <!-- Repetir Contraseña -->
                    <div>
                        <x-input-label for="password_confirm" :value="__('Repetir Contraseña')" />
                        <input wire:model='password_confirm' id="password_confirm" wire:dirty.class='border-green-500'
                            class="w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm text-sm"
